\ifndef{informationTopographyMotivation}
\define{informationTopographyMotivation}
...
\notes{However, no formal mathematical definition was given. The inaccessible game is an attempt to provide one.}
