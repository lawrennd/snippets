...
\plotcode{plot.lagrange_parallel_vectors(diagrams='\writeDiagramsDir/maths/')}

\setupdisplaycode{import notutils as nu
from ipywidgets import IntSlider}
\displaycode{nu.display_plots('lagrange-parallel-vectors{sample:0>3}.svg',
                                          directory='\writeDiagramsDir/maths',
                                          sample=IntSlider(0, 0, 12, 1))}

\slides{\define{width}{70%}
\startanimation{lagrange-parallel-vectors}{0}{13}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors000}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors001}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors002}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors003}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors004}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors005}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors006}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors007}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors008}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors009}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors010}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors011}{\width}}{lagrange-parallel-vectors}
\newframe{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors012}{\width}}{lagrange-parallel-vectors}
\endanimation}

\notes{\figure{\includediagram{\diagramsDir/maths/lagrange-parallel-vectors012}{70%}}{At stationarity, $\nabla f + \lambda\nabla g = \mathbf{0}$: the objective gradient is balanced by the constraint gradient scaled by $\lambda$ (here $\lambda = -\frac{1}{2}$ in the worked example).}{lagrange-parallel-vectors-figure}}
