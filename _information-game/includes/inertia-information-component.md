...
\notes{In the classical limit of the maximum entropy game, the entropic gradient dynamics formalize into precise analogues of Newton's equations. Specifically, when we decompose the dynamics of future variables:}
$$
\frac{d\boldsymbol{\theta}_{X_1}}{dt} = G_{X_1X_0}\boldsymbol{\theta}_{X_0} + G_{X_1M}\boldsymbol{\theta}_{M} + G_{X_1X_1}\boldsymbol{\theta}_{X_1}
$$
